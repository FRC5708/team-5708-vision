...
namespace grip {
	...
	ContourGrip::ContourGrip() {
	}
	/**
	 * Runs an iteration of the pipeline and updates outputs.
	 */
	void ContourGrip::Process(cv::Mat& source0){
		//Step HSL_Threshold0:
		//input
	 ...
	 */
	cv::Mat* ContourGrip::GetHslThresholdOutput(){
	 ...
	 */
	std::vector<std::vector<cv::Point> >* ContourGrip::GetFindContoursOutput(){
	 ...
	 */
	std::vector<std::vector<cv::Point> >* ContourGrip::GetFilterContoursOutput(){
	...
	void ContourGrip::hslThreshold(cv::Mat &input, double hue[], double sat[], double lum[], cv::Mat &out) {
	 ...
	 */
	void ContourGrip::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void ContourGrip::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
